...
## Užsikrėtimų skaičius per paskutines 14d. / pop
...
ggplot(df, aes(fill=percent))+
  ...
  scale_fill_gradientn(colours=brewer.pal(name ="YlOrRd", n=9),
                       ...
                       #trans="log",
                       na.value = "grey100")+
  labs(title="Atvejų skaičius tenkantis 100 000 gyventojų per paskutines 14 dienų",
       subtitle = "Šaltinis: NVSC, skaičiavimai: Corona-Stat.lt")
...
```{r}
date <- Sys.Date()-2
url <- paste0("https://covid19-static.cdn-apple.com/covid19-mobility-data/2023HotfixDev27/v3/en-us/applemobilitytrends-",date,".csv")
