...
ggplot(df, aes(age_group,value, fill=sex))+
  geom_bar(stat="identity",
           position="dodge")+
  scale_fill_brewer(palette="Set1")+
  labs(title="Užsikrėtimai pagal amžiaus kategorijas, paskutinės 30d.",
       subtitle="Šaltinis: NVSC, skaičiavimai: Corona-Stat.lt",
       x="Amžiaus grupė", 
       y="Užsikrėtimų skaičius")+
  theme(legend.title=element_blank(),
...
ggplot(df, aes(age_group,value, fill=sex))+
  geom_bar(stat="identity",
           position="dodge")+
  scale_fill_brewer(palette="Set1")+
  labs(title="Atvejai pagal amžiaus kategorijas, paskutinės 30 dienų",
       subtitle="Šaltinis: NVSC, skaičiavimai: Corona-Stat.lt",
       x="Amžiaus grupė", 
       y="Mirusiųjų skaičius")+
  theme(legend.title=element_blank(),
