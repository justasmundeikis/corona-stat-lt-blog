...
## Taigimų testų vs patvirtintų atvejų skaičius

Įprastai VLK pateikiamas **atliktų testų** ir juose nustatytų **teigiamų** ir **naujų teigiamų** COVID19 atvejų skaičius ir NVSC pateikiamas **patvirtintų atvejų skaičius** reikšmingai nesiskiria. Tačiau kartais, šioje vietoje preziumuoju, kai NVSC nespėja patvirtinti, sukaupia back-log'ą, o testų būna atliekama mažiau, NVSC pasiveja, šie skaičiai gali reikšmingai išsiskirti, kaip tai įvyko 2020-12-25. 

Dėl šių aplinkybių gali labai reikšmingai skirtis teigiamų atvejų ir atliktų testų skaičius. Remiantis tik VLK testų duomenimis 2020-12-25 teigiamų testų ir atliktų testų santykis siekė 29.7%, tuo tarpu klaidingai skaičiuojant NVSC patvirtintų atvejų santykį su atliktų testų skaičiumi (kaip tai daro arba galbūt jau darė? [Statistikos departamentas](https://osp.maps.arcgis.com/apps/MapSeries/index.html?appid=c6bc9659a00449239eb3bde062d23caa)), toks rodiklis siekė  net 48.1%.
...
```{r}
date <- Sys.Date()-2
url <- paste0("https://covid19-static.cdn-apple.com/covid19-mobility-data/2023HotfixDev18/v3/en-us/applemobilitytrends-",date,".csv")
