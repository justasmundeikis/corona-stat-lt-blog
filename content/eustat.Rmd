...
#### Bendras skaičius
Bendras atvejų skaičius Europos ekonominėje erdveje (EEE) apima šias šalis: BE, BG, CZ, DK, DE, EE, IE, EL, ES, FR, HR, IT, CY, LV, LT, LU, HU, MT, NL, AT, PL, PT, RO, SI, SK, FI, SE, UK, IS, LI, NO, CH.
...
ggplot(df,aes(x=reorder(valstybe,-value), y=value)) +
  ...
  labs(x="Valstybė", 
       y="Užsikrėtimų skaičius", 
       title="Naujų atvejų skaičius per paskutines 14 dienų",
       subtitle="Šaltinis: JHCSSE, skaičiavimai: Corona-Stat.lt" )+
  theme(legend.title=element_blank(),
