...
ggplot(df, aes(fill=value))+
  ...
  labs(title=paste0("Patvirtintų atveju skaičius tūkst. ", max.date),
...
my_breaks <- c(0.1,1,5, round(max(df$value, na.rm = T)*0.9))
...
ggplot(df,aes(x=reorder(valstybe,-value), y=value)) +
  ...
  labs(x="Valstybė", 
       y="Užsikrėtimų skaičius", 
       title=paste0("Užsikrėtimų skaičius, tūkst. ( ", max.date, " duomenimis)"),
       subtitle="Šaltinis: JHCSSE, skaičiavimai: Corona-Stat.lt" )+
  theme(legend.title=element_blank(),
...
ggplot(df,aes(x=reorder(valstybe,-value), y=value)) +
  ...
  labs(x="Valstybė", 
       y="Užsikrėtimų skaičius", 
       title=paste0("Naujų užsikrėtimų skaičius per paskutinę dieną, tūkst. ( ", max.date, " duomenimis)"),
       subtitle="Šaltinis: JHCSSE, skaičiavimai: Corona-Stat.lt" )+
  theme(legend.title=element_blank(),
        legend.position='none',
        axis.text.x=element_text(angle=45, hjust=1))
...
ggplot(df,aes(x=reorder(valstybe,-value), y=value)) +
  ...
  labs(x="Valstybė", 
       y="Užsikrėtimų skaičius", 
       title=paste0("Užsikrėtimų skaičius 1 tūkst. gyventojų ( ", max.date, " duomenimis)"),
       subtitle="Šaltinis: JHCSSE, Skaičiavimai: Corona-Stat.lt" )+
  theme(legend.title=element_blank(),
        legend.position='none',
        axis.text.x=element_text(angle=45, hjust=1))
